...
// Global instance
let matrixCarouselManager;

// Initialize when DOM is ready
document.addEventListener('DOMContentLoaded', () => {
    matrixCarouselManager = new MatrixCarouselManager();
    matrixCarouselManager.init();
});

// Global functions for buttons
window.changeMatrix = (offset) => {
    if (matrixCarouselManager) {
        matrixCarouselManager.changeMatrix(offset);
    }
};
